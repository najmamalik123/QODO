...
<link rel="stylesheet" href="<?= base_url('assets/fonts/font-awesome/fontawesome.css') ?>">
...
<link rel="stylesheet" href="<?= base_url('assets/css/custom/index.css') ?>">
<link rel="icon" href="<?php echo base_url('assets/images/'); ?>">
                    ...
                    <div class="header-right">
                        <ul class="header-list">
                            <li class="header-item">
                                <a class='header-widget' href='bookmark.html'>
                                ...
                                <div class="dropdown-card">
                                    ...
                                    <ul class="message-list">
                                        <li class="message-item unread">
                                            <a class='message-link' href='message.html'>
                                                <div class="message-img active">
<img src="<?php echo base_url('application/views/frontend/assets/images/avatar/01.jpg'); ?>" alt="avatar">
                                                </div>
                                        ...
                                        <li class="message-item">
                                            <a class='message-link' href='message.html'>
                                                <div class="message-img active">
<img src="<?php echo base_url('application/views/frontend/assets/images/avatar/03.jpg'); ?>" alt="avatar">
                                                </div>
                                                <div class="message-text">
                                        ...
                                        <li class="message-item unread">
                                            <a class='message-link' href='message.html'>
                                                <div class="message-img">
                                                    <img src="<?php echo base_url('application/views/frontend/assets/images/avatar/02.jpg'); ?>" alt="avatar">
                                                </div>
                                                <div class="message-text">
                                        ...
                                        <li class="message-item">
                                            <a class='message-link' href='message.html'>
                                                <div class="message-img active">
                                                    <img src="<?php echo base_url('application/views/frontend/assets/images/avatar/04.jpg'); ?>" alt="avatar">
                                                </div>
                                                <div class="message-text">
                                        ...
                                        <li class="message-item">
                                            <a class='message-link' href='message.html'>
                                                <div class="message-img">
                                                    <img src="<?php echo base_url('application/views/frontend/assets/images/user.png'); ?>" alt="avatar">
                                                </div>
                                                <div class="message-text">
...
<a class="btn btn-inline post-btn" href="<?php echo base_url('ad-post.html'); ?>">
        ...
        <aside class="sidebar-part">
            <div class="sidebar-body">
                <div class="sidebar-header">
                    <a class='sidebar-logo' href='index.htm'><img src="<?php echo base_url(\'application/views/frontend/assets/images/logo.png\'); ?>" alt="logo"></a>
                    <button class="sidebar-cross"><i class="fas fa-times"></i></button>
                </div>
                <div class="sidebar-content">
                    <div class="sidebar-profile">
                        <a href="#" class="sidebar-avatar"><img src="<?php echo base_url(\'application/views/frontend/assets/images/avatar/01.jpg\'); ?>" alt="avatar"></a>
                        <h4><a href="#" class="sidebar-name">Jackon Honson</a></h4>
                        <a class='btn btn-inline sidebar-post' href='ad-post.html'>
                            <i class="fas fa-plus-circle"></i>
                            <span>post your ad</span>
                        </a>
                    </div>
                    <div class="sidebar-menu">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#author-menu" class="nav-link" data-bs-toggle="tab">Author Menu</a></li>
                        </ul>

                        <div class="tab-pane active" id="main-menu">
                            <ul class="navbar-list">
                                <li class="navbar-item"><a class='navbar-link' href='index.htm'>Home</a></li>
        ...
        <nav class="mobile-nav">
            <div class="container">
                <div class="mobile-group">
                    <a class='mobile-widget' href='index.htm'>
        ...
        <section class="suggest-part">
            <div class="container">
                <div class="suggest-slider slider-arrow">
                    <a class='suggest-card' href='ad-list-column3.html'>
<img src="<?= base_url('assets/images/suggest/automobile.png'); ?>" alt="car">
                        <h6>automobile</h6>
                        <p>(4,521) ads</p>
                    </a>
                    <a class='suggest-card' href='ad-list-column3.html'>
                       
                    <img src="<?= base_url('assets/images/suggest/furniture.png'); ?>" alt="furniture">

                        <h6>furniture</h6>
                        <p>(4,521) ads</p>
                    </a>
                    <a class='suggest-card' href='ad-list-column3.html'>
<img src="<?= base_url('assets/images/suggest/properties.png'); ?>" alt="house">
...
<img src="<?= base_url('assets/images/suggest/fashion.png'); ?>" alt="food">
                    <h6>fashion</h6>
                        <p>(4,521) ads</p>
                    </a>
                    <a class='suggest-card' href='ad-list-column3.html'>
<img src="<?= base_url('assets/images/suggest/electronics.png'); ?>" alt="cycle">

                    <h6>electronics</h6>
                        <p>(4,521) ads</p>
                    </a>
                    <a class='suggest-card' href='ad-list-column3.html'>
                      <img src="<?= base_url('assets/images/suggest/hospitality.png'); ?>" alt="clothes">
                    ...
                    <a class='suggest-card' href='ad-list-column3.html'>
<img src="<?= base_url('assets/images/suggest/gadgets.png'); ?>" alt="computer">

                    <h6>gadgets</h6>
                        <p>(4,521) ads</p>
                    </a>
                    <a class='suggest-card' href='ad-list-column3.html'>
                       <img src="<?= base_url('assets/images/suggest/education.png'); ?>" alt="phone">
                    ...
                    <img src="<?= base_url('assets/images/suggest/software.png'); ?>" alt="scooter">
                    ...
                    <a class='suggest-card' href='ad-list-column3.html'>
                        ...
                        <img src="<?= base_url('assets/images/suggest/food.png'); ?>" alt="television">

                        <h6>food</h6>
                        <p>(4,521) ads</p>
                    </a>
                    <a class='suggest-card' href='ad-list-column3.html'>
<img src="<?php echo base_url('assets/images/suggest/services.png'); ?>" alt="truck">
                        <h6>services</h6>
                        <p>(4,521) ads</p>
                    </a>
                    <a class='suggest-card' href='ad-list-column3.html'>
                       
<img src="<?php echo base_url('assets/images/suggest/animals.png'); ?>" alt="pet">
                ...
                <div class="row">
                    <div class="col-md-5 col-lg-6">
                        <div class="section-side-heading">
                            <h2>Find your needs in our best <span>Featured Classified Ads</span></h2>
                            ...
                            <a class='btn btn-inline' href='ad-list-column3.html'>
                                <i class="fas fa-eye"></i>
                        ...
                        <div class="feature-card-slider slider-arrow">
                            <div class="feature-card">
                                <a href="#" class="feature-img">
                                    <img src="<?php echo base_url(\'application/views/frontend/assets/images/product/10.jpg\'); ?>" alt="feature">
                                </a>
                            ...
                            <div class="feature-card">
                                <a href="#" class="feature-img">
                                    <img src="<?php echo base_url(\'application/views/frontend/assets/images/product/01.jpg\'); ?>" alt="feature">
                                </a>
                                <div class="cross-inline-badge feature-badge">
                                    <span>featured</span>
                                    <i class="fas fa-book-open"></i>
                            ...
                            <div class="feature-card">
                                <a href="#" class="feature-img">
                                    <img src="<?php echo base_url(\'application/views/frontend/assets/images/product/08.jpg\'); ?>" alt="feature">
                                </a>
                                <div class="cross-inline-badge feature-badge">
                                    <span>featured</span>
                                    <i class="fas fa-book-open"></i>
                            ...
                            <div class="feature-card">
                                <a href="#" class="feature-img">
<img src="<?= base_url('assets/images/product/06.jpg'); ?>" alt="feature">
                                </a>
                                <div class="cross-inline-badge feature-badge">
                                    <span>featured</span>
                                    <i class="fas fa-book-open"></i>
                        ...
                        <div class="feature-thumb-slider">
                            <div class="feature-thumb"><img src="<?= base_url('images/product/10.jpg') ?>" alt="feature"></div>
                            <div class="feature-thumb"><img src="<?php echo base_url(\'application/views/frontend/assets/images/product/01.jpg\'); ?>" alt="feature"></div>
                            <div class="feature-thumb"><img src="<?php echo base_url(\'application/views/frontend/assets/images/product/08.jpg\'); ?>" alt="feature"></div>
                            <div class="feature-thumb"><img src="<?php echo base_url(\'application/views/frontend/assets/images/product/06.jpg\'); ?>" alt="feature"></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="recomend-slider slider-arrow">
                            <div class="product-card">
                                <div class="product-media">
                                    <div class="product-img">
                                        <img src="<?php echo base_url(\'application/views/frontend/assets/images/product/01.jpg\'); ?>" alt="product">
                                    </div>
                            ...
                            <div class="product-card">
                                <div class="product-media">
                                    <div class="product-img">
                                        <img src="<?php echo base_url(\'application/views/frontend/assets/images/product/03.jpg\'); ?>" alt="product">
                                    </div>
                                    <div class="cross-vertical-badge product-badge">
                                        <i class="fas fa-clipboard-check"></i>
                                        <span>recommend</span>
                            ...
                            <div class="product-card">
                                <div class="product-media">
                                    <div class="product-img">
                                        <img src="<?php echo base_url(\'application/views/frontend/assets/images/product/10.jpg\'); ?>" alt="product">
                                    </div>
                                    <div class="cross-vertical-badge product-badge">
                                        <i class="fas fa-clipboard-check"></i>
                                        <span>recommend</span>
                            ...
                            <div class="product-card">
                                <div class="product-media">
                                    <div class="product-img">
                                        <img src="<?php echo base_url(\'application/views/frontend/assets/images/product/09.jpg\'); ?>" alt="product">
                                    </div>
                                    <div class="cross-vertical-badge product-badge">
                                        <i class="fas fa-clipboard-check"></i>
                                        <span>recommend</span>
                            ...
                            <div class="product-card">
                                <div class="product-media">
                                    <div class="product-img">
                                        <img src="<?php echo base_url(\'application/views/frontend/assets/images/product/02.jpg\'); ?>" alt="product">
                                    </div>
                                    <div class="cross-vertical-badge product-badge">
                                        <i class="fas fa-clipboard-check"></i>
                                        <span>recommend</span>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-11 col-lg-8 col-xl-6">
                        <div class="product-card standard">
                            <div class="product-media">
                                <div class="product-img">
                                    <img src="<?php echo base_url(\'application/views/frontend/assets/images/product/04.jpg\'); ?>" alt="product">
                                </div>
                                <div class="cross-vertical-badge product-badge">
                                    <i class="fas fa-bolt"></i>
                                    <span>trending</span>
                    ...
                    <div class="col-md-11 col-lg-8 col-xl-6">
                        <div class="product-card standard">
                            <div class="product-media">
                                <div class="product-img">
                                    <img src="<?php echo base_url(\'application/views/frontend/assets/images/product/05.jpg\'); ?>" alt="product">
                                </div>
                                <div class="cross-vertical-badge product-badge">
                                    <i class="fas fa-bolt"></i>
                                    <span>trending</span>
                    ...
                    <div class="col-md-11 col-lg-8 col-xl-6">
                        <div class="product-card standard">
                            <div class="product-media">
                                <div class="product-img">
                                    <img src="<?php echo base_url(\'application/views/frontend/assets/images/product/06.jpg\'); ?>" alt="product">
                                </div>
                                <div class="cross-vertical-badge product-badge">
                                    <i class="fas fa-bolt"></i>
                                    <span>trending</span>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                            <div class="product-card">
                                <div class="product-media">
                                    <div class="product-img">
                                        <img src="<?php echo base_url(\'application/views/frontend/assets/images/product/07.jpg\'); ?>" alt="product">
                                    </div>
                                    <div class="cross-vertical-badge product-badge">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                            <div class="product-card">
                                <div class="product-media">
                                    <div class="product-img">
                                        <img src="<?php echo base_url(\'application/views/frontend/assets/images/product/08.jpg\'); ?>" alt="product">
                                    </div>
                                    <div class="cross-vertical-badge product-badge">
                                        <i class="fas fa-fire"></i>
                                        <span>top niche</span>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                            <div class="product-card">
                                <div class="product-media">
                                    <div class="product-img">
                                        <img src="<?php echo base_url(\'application/views/frontend/assets/images/product/11.jpg\'); ?>" alt="product">
                                    </div>
                                    <div class="cross-vertical-badge product-badge">
                                        <i class="fas fa-fire"></i>
                                        <span>top niche</span>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                            <div class="product-card">
                                <div class="product-media">
                                    <div class="product-img">
                                        <img src="<?php echo base_url(\'application/views/frontend/assets/images/product/13.jpg\'); ?>" alt="product">
                                    </div>
                                    <div class="cross-vertical-badge product-badge">
                                        <i class="fas fa-fire"></i>
                                        <span>top niche</span>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                            <div class="product-card">
                                <div class="product-media">
                                    <div class="product-img">
                                        <img src="<?php echo base_url(\'application/views/frontend/assets/images/product/14.jpg\'); ?>" alt="product">
                                    </div>
                                    <div class="cross-vertical-badge product-badge">
                                        <i class="fas fa-fire"></i>
                                        <span>top niche</span>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                            <div class="product-card">
                                <div class="product-media">
                                    <div class="product-img">
                                        <img src="<?php echo base_url(\'application/views/frontend/assets/images/product/15.jpg\'); ?>" alt="product">
                                    </div>
                                    <div class="cross-vertical-badge product-badge">
                                        <i class="fas fa-fire"></i>
                                        <span>top niche</span>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-lg-3">
                        <a class='city-card' href='ad-list-column3.html' style='background: url(images/cities/01.jpg) no-repeat center; background-size: cover'>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <a class='city-card' href='ad-list-column3.html' style='background: url(images/cities/02.jpg) no-repeat center; background-size: cover'>
                            <div class="city-content">
                                <h4>san francisco</h4>
                                <p>(25) ads</p>
                            </div>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-5">
                        <a class='city-card' href='ad-list-column3.html' style='background: url(images/cities/03.jpg) no-repeat center; background-size: cover'>
                            <div class="city-content">
                                <h4>california</h4>
                                <p>(25) ads</p>
                            </div>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-5">
                        <a class='city-card' href='ad-list-column3.html' style='background: url(images/cities/04.jpg) no-repeat center; background-size: cover'>
                            <div class="city-content">
                                <h4>new york</h4>
                                <p>(25) ads</p>
                            </div>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <a class='city-card' href='ad-list-column3.html' style='background: url(images/cities/05.jpg) no-repeat center; background-size: cover'>
                            <div class="city-content">
                                <h4>manhattan</h4>
                                <p>(25) ads</p>
                            </div>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3">
                        <a class='city-card' href='ad-list-column3.html' style='background: url(images/cities/06.jpg) no-repeat center; background-size: cover'>
                            <div class="city-content">
                                <h4>Baltimore</h4>
                                <p>(25) ads</p>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="center-20">
                            <a class='btn btn-inline' href='cities.html'>
                                <i class="fas fa-eye"></i>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                        <div class="category-card">
                            <div class="category-head">
                                <img src="<?php echo base_url(\'application/views/frontend/assets/images/category/electronics.jpg\'); ?>" alt="category">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                        <div class="category-card">
                            <div class="category-head">
                                <img src="<?php echo base_url(\'application/views/frontend/assets/images/category/gadgets.jpg\'); ?>" alt="category">
                                <a href="#" class="category-content">
                                    <h4>gadgets</h4>
                                    <p>(3678)</p>
                                </a>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                        <div class="category-card">
                            <div class="category-head">
                                <img src="<?php echo base_url(\'application/views/frontend/assets/images/category/furnitures.jpg\'); ?>" alt="category">
                                <a href="#" class="category-content">
                                    <h4>furnitures</h4>
                                    <p>(3678)</p>
                                </a>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                        <div class="category-card">
                            <div class="category-head">
                                <img src="<?php echo base_url(\'application/views/frontend/assets/images/category/animals.jpg\'); ?>" alt="category">
                                <a href="#" class="category-content">
                                    <h4>animals</h4>
                                    <p>(3678)</p>
                                </a>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                        <div class="category-card">
                            <div class="category-head">
                                <img src="<?php echo base_url(\'application/views/frontend/assets/images/category/fashions.jpg\'); ?>" alt="category">
                                <a href="#" class="category-content">
                                    <h4>fashions</h4>
                                    <p>(3678)</p>
                                </a>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                        <div class="category-card">
                            <div class="category-head">
                                <img src="<?php echo base_url(\'application/views/frontend/assets/images/category/motorbikes.jpg\'); ?>" alt="category">
                                <a href="#" class="category-content">
                                    <h4>motorbikes</h4>
                                    <p>(3678)</p>
                                </a>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                        <div class="category-card">
                            <div class="category-head">
                                <img src="<?php echo base_url(\'application/views/frontend/assets/images/category/properties.jpg\'); ?>" alt="category">
                                <a href="#" class="category-content">
                                    <h4>properties</h4>
                                    <p>(3678)</p>
                                </a>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                        <div class="category-card">
                            <div class="category-head">
                                <img src="<?php echo base_url(\'application/views/frontend/assets/images/category/automobiles.jpg\'); ?>" alt="category">
                                <a href="#" class="category-content">
                                    <h4>automobiles</h4>
                                    <p>(3678)</p>
                                </a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="center-20">
                            <a class='btn btn-inline' href='category-list.html'>
                                <i class="fas fa-eye"></i>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="blog-slider slider-arrow">
                            <div class="blog-card">
                                <div class="blog-img">
                                    <img src="<?php echo base_url(\'application/views/frontend/assets/images/blog/01.jpg\'); ?>" alt="blog">
                            ...
                            <div class="blog-card">
                                <div class="blog-img">
                                    <img src="<?php echo base_url(\'application/views/frontend/assets/images/blog/02.jpg\'); ?>" alt="blog">
                                    <div class="blog-overlay">
                            ...
                            <div class="blog-card">
                                <div class="blog-img">
                                    <img src="<?php echo base_url(\'application/views/frontend/assets/images/blog/03.jpg\'); ?>" alt="blog">
                                    <div class="blog-overlay">
                            ...
                            <div class="blog-card">
                                <div class="blog-img">
                                    <img src="<?php echo base_url(\'application/views/frontend/assets/images/blog/04.jpg\'); ?>" alt="blog">
                                    <div class="blog-overlay">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-3">
                        <div class="footer-info">
                            <a href="#"><img src="<?php echo base_url(\'application/views/frontend/assets/images/logo.png\'); ?>" alt="logo"></a>
                    ...
                    <div class="col-lg-12">
                        <div class="footer-card-content">
                            <div class="footer-payment">
                                <a href="#"><img src="<?php echo base_url(\'application/views/frontend/assets/images/pay-card/01.jpg\'); ?>" alt="01"></a>
                                <a href="#"><img src="<?php echo base_url(\'application/views/frontend/assets/images/pay-card/02.jpg\'); ?>" alt="02"></a>
                                <a href="#"><img src="<?php echo base_url(\'application/views/frontend/assets/images/pay-card/03.jpg\'); ?>" alt="03"></a>
                                <a href="#"><img src="<?php echo base_url(\'application/views/frontend/assets/images/pay-card/04.jpg\'); ?>" alt="04"></a>
                            </div>
                            <div class="footer-option">
                                <button type="button" data-bs-toggle="modal" data-bs-target="#language"><i class="fas fa-globe"></i>English</button>
                                <button type="button" data-bs-toggle="modal" data-bs-target="#currency"><i class="fas fa-dollar-sign"></i>USD</button>
                            </div>
                            <div class="footer-app">
                                <a href="#"><img src="<?php echo base_url(\'application/views/frontend/assets/images/play-store.png\'); ?>" alt="play-store"></a>
                                <a href="#"><img src="<?php echo base_url(\'application/views/frontend/assets/images/app-store.png\'); ?>" alt="app-store"></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        =======================================-->
        <!-- VENDOR -->
        <script src="<?php echo base_url(\'application/views/frontend/assets/js/vendor/jquery-1.12.4.min.js\'); ?>"></script>
        <script src="<?php echo base_url(\'application/views/frontend/assets/js/vendor/popper.min.js\'); ?>"></script>
        <script src="<?php echo base_url(\'application/views/frontend/assets/js/vendor/bootstrap.min.js\'); ?>"></script>
        <script src="<?php echo base_url(\'application/views/frontend/assets/js/vendor/slick.min.js\'); ?>"></script>

        <!-- CUSTOM -->
        <script src="<?php echo base_url(\'application/views/frontend/assets/js/custom/slick.js\'); ?>"></script>
        <script src="<?php echo base_url(\'application/views/frontend/assets/js/custom/main.js\'); ?>"></script>
        <!--=====================================
                    JS LINK PART END
        =======================================-->
    </body>
