        ...
        <aside class="sidebar-part">
            <div class="sidebar-body">
                <div class="sidebar-header">
                    <a class='sidebar-logo' href='index.htm'><img src="images/logo.png" alt="logo"></a>
...
<img src="<?= base_url('assets/images/product/06.jpg'); ?>" alt="feature">
    ...
    <div class="feature-thumb">
        <img src="<?= base_url('assets/images/product/10.jpg'); ?>" alt="feature">
    </div>
    <div class="feature-thumb">
        <img src="<?= base_url('assets/images/product/01.jpg'); ?>" alt="feature">
    </div>
    <div class="feature-thumb">
        <img src="<?= base_url('assets/images/product/08.jpg'); ?>" alt="feature">
    </div>
    <div class="feature-thumb">
        <img src="<?= base_url('assets/images/product/06.jpg'); ?>" alt="feature">
    </div>
                    ...
                    <div class="product-card">
                        <div class="product-media">
                            <div class="product-img">
                                <img src="<?= base_url('assets/images/product/01.jpg'); ?>" alt="product">
                            </div>
