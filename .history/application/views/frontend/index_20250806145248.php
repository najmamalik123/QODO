...
<html lang="en">
    <head>
        ...
        =======================================-->
        <!-- FAVICON -->
        <link rel="icon" href="<?php echo base_url('application/views/frontend/images/favicon.png'); ?>">

<!-- FONTS -->
<link rel="stylesheet" href="<?php echo base_url('application/views/frontend/fonts/flaticon/flaticon.css'); ?>">
<link rel="stylesheet" href="<?php echo base_url('application/views/frontend/fonts/font-awesome/fontawesome.css'); ?>">

<!-- VENDOR -->
<link rel="stylesheet" href="<?php echo base_url('application/views/frontend/css/vendor/slick.min.css'); ?>">
<link rel="stylesheet" href="<?php echo base_url('application/views/frontend/css/vendor/bootstrap.min.css'); ?>">

<!-- CUSTOM -->
<link rel="stylesheet" href="<?php echo base_url('application/views/frontend/css/custom/main.css'); ?>">

        <link rel="stylesheet" href="<?php echo base_url('application/views/frontend/css/custom/index.css'); ?>">
