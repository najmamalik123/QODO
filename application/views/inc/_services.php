   <section class="appie-about-8-area pt-100 pb-100 my-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="appie-section-title mb-30">
                        <h3 class="appie-title">We do things that matters <br> Checkout some of our services </h3>
                    </div>
                </div>
            </div>
            <div class="row">
                <?php
                $theservices=get_web_elements('services','1','4');
                $theclass='col-lg-7';
