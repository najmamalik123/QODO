		...
		<div class="d-flex justify-content-center align-items-center vh-100">
			<div class="row position-relative col-md-4 col-12">
				<div class="bg-white p-4 feed-item rounded-4 shadow-sm faq-page">
					...
					<div class="mb-3 text-center">
						<p class="text-body mb-0">Enter the OTP sent to your email</p>
					</div>
					<div class="row justify-content-center">
						<div class="col-lg-12">
							<form class="form-floating-space" action="<?= base_url('index.php/action/opt-verify') ?>" method="post" onsubmit="return ajaxsubmitform('<?= base_url('index.php/action/opt-verify') ?>',this,'error_div','loder_div','<?= base_url('index.php/main/categories') ?>','0');">
								<!-- Username input -->
								<div class="form-floating mb-3 position-relative">
									<input class="form-control rounded-5" id="otp" type="number" min="0" maxlength="4" name="eotp" placeholder="Enter OTP" value="<?= @$_SESSION['signup_code_phone'] ?>" required>
