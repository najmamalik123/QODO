				...
				<div class="main-content">
					...
					<div class="tab-content" id="pills-tabContent">
						<div class="tab-pane fade show active" id="pills-people" role="tabpanel" aria-labelledby="pills-people-tab">
							<h6 class="mb-3 fw-bold text-body">Investors you can follow</h6>
							<div class="bg-white rounded-4 overflow-hidden mb-4 shadow-sm">
								<!-- Account Item -->
								<?php if (count($vendors) > 0) {
									foreach ($vendors as $vendor) { ?>
										<a href="<?= base_url('userprofile/' . $vendor['username']) ?>" class="p-3 border-bottom d-flex text-dark text-decoration-none account-item pf-item">
									...
									<div class="alert alert-warning">No Investors found</div>
								<?php } ?>
							</div>
						</div>
					</div>
