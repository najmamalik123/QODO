				...
				<div class="main-content">
					...
					<div class="bg-white rounded-4 shadow-sm profile">
						<div class="d-flex align-items-center px-3 pt-3">
							...
							<div class="ms-3">
								<h6 class="mb-0 d-flex align-items-center text-body fs-6 fw-bold">
									<?= $profile_data['name'] ?>

									<!-- Member Badge -->
									<?php if ($profile_data['user_plan'] == 'member') { ?>
										<span class="badge bg-success ms-2 rounded-pill px-2 py-1" style="font-size: 0.75rem;">
											<i class="fa fa-crown me-1" style="font-size: 15px;"></i> Member
										</span>
									<?php } ?>
								...
								<div class="feeds" id="feed">
									...
									<?php if (count($posts) > 0) {
										...
										<div class="bg-white p-3 feed-item rounded-4 mb-3 shadow-sm d-flex justify-content-center align-items-center text-center" style="min-height: 50px;">
											<p class="text-dark m-0">No Posts found</p>
										</div>
									<?php } ?>
								</div>
							</div>
