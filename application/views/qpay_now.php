         ...
         <div class="col-xxl-5 offset-xxl-1 col-xl-6 col-lg-6">
            <div class="about__thumb-wrapper">
               <div class="about__thumb">
                  <img width="100%" src="https://images.pexels.com/photos/8937451/pexels-photo-8937451.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260">
               </div>
            </div>
         </div>
         <div class="col-xxl-6 col-xl-6 col-lg-6">
            <div class="about__content pl-70 pr-60 pt-25">
               ...
               <p>
                    ...
                    <span class=" ec-bill-wrap ">
                        <hr/>
                        <button type="button" onclick="razorpaySubmit(this);" class="btn btn-primary text-white font-weight-bold px-5 col-11">Pay Now</button>
                    </span>
               </p>
            </div>
         </div>
